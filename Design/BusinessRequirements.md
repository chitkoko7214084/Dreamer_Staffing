Business Requirement 1: Online Application & Submission
...
Business Requirement 2: Automated Applicant Scoring & Categorization
...
The categorization must be visually represented to staff. For example, a color-coded system (e.g., Green for High, Yellow for Medium, Red for Low) should be implemented.
2.3 Staff Interface
